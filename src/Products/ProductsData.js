...
'Matte Lamination (clean, smooth, premium look):',
'Scratch-Resistant Surface:',
'Strong Adhesive — sticks firmly:',
'Easy Peel Design — quick application:',
'Works with pen, marker & printing:',
...
'Share your required size, shape, or dimensions — we will make it exactly as you need:'
]
},
...
'Matte lamination — waterproof & scratch-resistant:',
...
'Saves time and keeps everything organized:',
...
,
    ...
    desc: [
 {
...

  {
    heading: '📌 Product Overview:',
    subParts: [
      '• Personalized acrylic business sign made with high-quality UV printing:',
...

  {
    ...
    subParts: [
      '• All sizes are fully customizable — simply share your required dimensions:',
...

  {
    ...
    subParts: [
      '• A design draft will be shared within 6 hours after your order:',
...

  {
    ...
    subParts: [
      ...
      '• Perfect for branding, décor, and business visibility:'
    ]
...
,
...

  {
    ...
    subParts: [
      ...
      '• All remaining names will scale proportionally (same font style, size adjusts based on length):',
      '• Stickers are made to **length**, not height — but you can request a height limit:'
    ]
  },

  {
    ...
    subParts: [
      ...
      '• These are NOT equal-length stickers — each name varies unless you request fixed length:',
...

  {
    heading: '🎨 Customization Options:',
    subParts: [
      '• Choose any text, name, or short phrase:',
...

  {
    ...
    subParts: [
      '• Orders dispatch in 1–3 business days:',
    ...
    desc: [
  {
    ...
    subParts: [
      '• Perfect for organizing spice jars, pantry containers, and kitchen bottles',
      '• Personalized labels for easy identification and stylish kitchen décor'
    ]
  },

  {
    ...
    subParts: [
      ...
      '• Custom text for your storage jars, canisters, and containers:',
...

  {
    ...
    subParts: [
      ...
      '• Stickers will be made according to your specifications:',
...

  {
    ...
    subParts: [
      ...
      '• We are happy to provide mockups and guidance for your kitchen stickers:'
    ]
  }
],
    ...
    desc:[
  {
    ...
    subParts: [
      ...
      '• Perfect for living rooms, meditation spaces, offices, and cozy corners:'
    ]
  },
...

  {
    ...
    subParts: [
      ...
      '• Thoughtful and elegant home décor:',
