...
const Logo = () => {
  return (
    <div className='flex justify-between items-center px-2 py-3 border-b-2 border-[#255235] relative pointer-events-none'>
        ...
        <h2 style={{fontSize:'clamp(25px,5vw,70px)'}} className='font-bold leading-none tracking-tighter text-center tracking-wide'><span className='text-[#255034]'>Chach Valley</span> Institute</h2>
